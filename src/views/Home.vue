        ...
        <div class="mowgrid grid-top">
          <div class="item exchange">
            ...
            <div class="pd-30" v-if="tab == 0">
              ...
              <div class="d-flex align-center">
                <span
                  >Giá ước tính: 1 {{ p2p_token.buy.toUpperCase() }} ≈
              ...
              <div class="detail-price">
                <div class="item">
                  ...
                  <h4>
                    ...
                    <b
                      v-if="
                        p2p_token.buy == 'usdt' && p2p_currency.buy == 'vnd'
                      "
            ...
            <div class="pd-30" v-else>
              ...
              <div class="d-flex align-center">
                <span
                  >Giá ước tính: 1 {{ p2p_token.sell.toUpperCase() }} ≈
              ...
              <div class="detail-price">
                <div class="item">
                  ...
                  <h4 class="sell-price">
                    ...
                    <b
                      v-if="
                        p2p_token.sell == 'usdt' && p2p_currency.sell == 'vnd'
                      "
          ...
          <div class="item pd-30">
            ...
            <v-tabs-items v-model="rate_tab">
              <v-tab-item>
                <v-data-table
                  :headers="headers.bank"
                  :items="bank"
                  :page.sync="page.bank_rate"
                  :items-per-page="9"
                  hide-default-footer
                  :mobile-breakpoint="0"
                >
                ...
                <v-pagination
                  class="pt-3"
                  v-model="page.bank_rate"
                  :length="Math.ceil(bank.length / 9)"
                >
                </v-pagination>
              </v-tab-item>
              <v-tab-item>
                ...
                >
                  ...
                  <template v-slot:[`item.change`]="{ item }">
                    <div
                      :class="{
                        'price-up': item.change > 0 ? true : false,
                        'price-down': item.change < 0 ? true : false,
                      }"
                    >
          ...
          <div class="item pd-30">
            ...
            >
              <template v-slot:[`item.buy`]="{ item }">
                ...
                <span
                  v-if="item.buy_change"
                  :class="{
                    'price-up': item.buy_change > 0 ? true : false,
                    'price-down': item.buy_change < 0 ? true : false,
                  }"
                >
              ...
              <template v-slot:[`item.sell`]="{ item }">
                ...
                <span
                  v-if="item.sell_change"
                  :class="{
                    'price-up': item.sell_change > 0 ? true : false,
                    'price-down': item.sell_change < 0 ? true : false,
                  }"
                >
            ...
            <v-pagination
              class="pt-3"
              v-model="page.gold"
              :length="Math.ceil(gold.length / 8)"
            >
            </v-pagination>
          </div>
        </div>
      ...
      <div class="mowtainer">
        <div class="mowgrid grid-2 mt-8">
          <div class="item pd-30">
            ...
            <v-data-table
              :headers="headers.crypto"
              :items="coin_list"
              :search="search"
              :page.sync="page.usdt_crypto"
              :items-per-page="17"
              hide-default-footer
              :mobile-breakpoint="0"
            >
              ...
              <template v-slot:[`item.price_change_percentage_24h`]="{ item }">
                <div
                  :class="{
                    'price-up':
                      item.price_change_percentage_24h > 0 ? true : false,
                    'price-down':
                      item.price_change_percentage_24h < 0 ? true : false,
                  }"
                >
            ...
            <v-pagination
              class="pt-3"
              v-model="page.usdt_crypto"
              :length="Math.ceil(coin_list.length / 17)"
            >
            </v-pagination>
          </div>
          <div>
            <div class="item pd-30 mb-8">
              ...
              >
                <template v-slot:[`item.five_minutes`]="{ item }">
                  <div
                    :class="{
                      'up-color': item.five_minutes.includes('Mua')
                        ? true
                        : false,
                      'down-color': item.five_minutes.includes('Bán')
                        ? true
                        : false,
                    }"
                  >
                ...
                <template v-slot:[`item.fifteen_minutes`]="{ item }">
                  <div
                    :class="{
                      'up-color': item.fifteen_minutes.includes('Mua')
                        ? true
                        : false,
                      'down-color': item.fifteen_minutes.includes('Bán')
                        ? true
                        : false,
                    }"
                  >
                ...
                <template v-slot:[`item.one_hour`]="{ item }">
                  <div
                    :class="{
                      'up-color': item.one_hour.includes('Mua') ? true : false,
                      'down-color': item.one_hour.includes('Bán')
                        ? true
                        : false,
                    }"
                  >
            ...
            <div class="item pd-30">
              ...
              >
                <template v-slot:[`item.change`]="{ item }">
                  <span
                    :class="{
                      'price-up': item.change.includes('+') ? true : false,
                      'price-down': item.change.includes('-') ? true : false,
                    }"
                  >
              ...
              <v-pagination
                class="pt-3"
                v-model="page.stock"
                :length="Math.ceil(stock.length / 7)"
              >
              </v-pagination>
            </div>
          </div>
